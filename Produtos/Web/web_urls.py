...
urlpatterns = [
    ...
    path('servicos/<str:prod_codi>/edit/', ServicosUpdateView.as_view(), name='servicos_edit_web'),
    path('servicos/<str:prod_codi>/delete/', ServicosDeleteView.as_view(), name='servicos_delete_web'),
