# Seu arquivo urls.py (ou urls incluído no principal)
# Presumindo que você já tem um padrão slug:/web/<slug>/...
# 
# No arquivo PRINCIPAL (urls.py do projeto):
# path('web/<slug:slug>/', include('nfse.Web.urls')),
#
# Isso faz com que a URL seja: /web/saveweb001/notas-de-servico/entidades-autocomplete/
...
from nfse.Web.Views.autocomplete import entidades_autocomplete, servicos_autocomplete
...
urlpatterns = [
    ...
    # API endpoints
    path('entidades-autocomplete/', entidades_autocomplete, name='entidades_autocomplete'),
    path('servicos-autocomplete/', servicos_autocomplete, name='servicos_autocomplete'),
]